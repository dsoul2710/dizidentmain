...
export default function RxSection({
  ...
  // --- Sync patientId from cookie / custom event for Doctors ---
  useEffect(() => {
  ...
  // Reset visitId when patient changes
  useEffect(() => {
    setVisitId("");
  }, [effectivePatientId]);
                ...
                {panelType === "ORG" ? (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={
                        effectivePatientId
                          ? `${patientInfo?.name || patientInfo?.fullName || getCookie("selectedPatientName") || `Patient #${effectivePatientId}`} (ID: ${effectivePatientId})`
